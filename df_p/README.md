...
## 隠し要素・ボス出現条件
このゲームには特定の条件で出現する「主（ヌシ）」や隠しボスが存在します。

| 名前 | 推定生息域 | 出現条件（ロープ接触回数） | 備考 |
|---|---|---|---|
| **クラーケン** | 200m ~ 1000m | 70回 | |
| **メガロドン** | 1000m ~ 2000m | 100回 | |
| **富士山** | 2000m ~ 3000m | 120回 | |
| **異形の神** | 3000m ~ 4000m | 100回 | |
| **マヨイアイオイクラゲ** | 4000m ~ | 200回 | **出現条件**: 「マリアナスネイルフィッシュ」を捕獲済みであること |
